        ...
        if (User('PROFILE') == 'admin' || UserStudentID() == $student_id) {
            ...
            foreach ($tcolumns as $tcolumn) {
                foreach ($tcolumn as $tsection) {
                    ...
                    $course_html[$colnum] .= '<th class="text-left f-s-12">'.'Course Title'.'</th><th class="text-left f-s-12">'.'Course Code'.'</th><th class="text-left f-s-12" width="20%">'._creditHours.'</th><th class="bg-grey f-s-12" width="5%">'.'Course Grade'.'</th><th class="text-left f-s-12" width="15%">'.'Grade Point'.'</th>';
                    $course_html[$colnum] .= '</tr>';
                    $course_html[$colnum] .= '</thead>';
            ...
            <div class="print-wrapper">
                <div class="print-header m-b-10 a">
                ...
                <div style="text-align: center;">
                    <img width="13%" src="assets/opensis_logo.png">
                </div>
                
                        <div><p style="text-align: center;font-size: 27px;">BITS College<br>School of Systems and Technology
<br>Student Grade Report</p></div>
...
?>
  ...
  <div class="column"><p style="font-size: 18px;">Semester: <?php echo $gradelevel;?></p></div>
                ...
                <table class="b" width="60%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
...
<div class="transcript-student-overview">
    ...
    <th class="p-r-30"><?="Total Credit Hours"?></td>
    <th class="p-r-30"><?="Total Grade Points"?></td>
    <th class="p-r-30"><?=_cumulativeGpa?></th>
</tr>    
    <tr>
            ...
            <td><?php echo sprintf("%01.2f", $tot_qp); ?></td>
...
<p style="font-size: 18px; font-weight: bold;">Status:</p>
  <div class="column"><p style="font-size: 18px;">________Very Great Distinction</p></div>
  <div class="column"><p style="font-size: 18px;">________Promoted</p></div>
  <div class="column"><p style="font-size: 18px;">________Great Distinction</p></div>
  <div class="column"><p style="font-size: 18px;">________Probation</p></div>
  <div class="column"><p style="font-size: 18px;">________Distinction</p></div>
  <div class="column"><p style="font-size: 18px;">________dismissed</p></div>
  <div class="column"><p style="font-size: 18px;"></p></div>
  <div class="column"><p style="font-size: 18px;">________Advised to Withdraw</p></div>
  <div class="column"><p style="font-size: 18px;"></p></div>
  ...
  <div class="column"><p style="font-size: 18px;">___________________<br>Vice President <br> Academic Affairs and Research</p></div>
</div>
                ...
                <div class="m-t-0 a">
                    ...
                    <table class="invoice-table table-bordered">
                        <thead>                            
                            <tr>
                                <th class="text-center f-s-12"><?=_a?></th>
